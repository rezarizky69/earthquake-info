...
import com.eja.earthquakeinfo.fragment.FragmentBerpotensi
import com.eja.earthquakeinfo.fragment.FragmentDirasakan
import com.eja.earthquakeinfo.fragment.FragmentTerkini
import com.eja.earthquakeinfo.networking.ApiEndpoint
import com.eja.earthquakeinfo.utils.BottomBarBehavior
...
import java.util.*
 ...
 class MainActivity : AppCompatActivity(), LocationListener {
     ...
     override fun onCreate(savedInstanceState: Bundle?) {
         ...
         //hide show tab
         val layoutParams = tabNavigation.layoutParams as CoordinatorLayout.LayoutParams
         layoutParams.behavior = BottomBarBehavior()
         if (savedInstanceState == null) {
             tabNavigation.selectTabById(R.id.tabTerkini, true)
             fragmentManager = supportFragmentManager
             val fragmentTerkini = FragmentTerkini()
             fragmentManager!!.beginTransaction().replace(R.id.frameContainer, fragmentTerkini).commit()
         }
         ...
         tabNavigation.setOnTabSelectListener(object : AnimatedBottomBar.OnTabSelectListener {
             override fun onTabSelected(lastIndex: Int, lastTab: AnimatedBottomBar.Tab?, newIndex: Int, newTab: AnimatedBottomBar.Tab) {
                 ...
                 when (newTab.id) {
                     ...
                     R.id.tabTerkini -> fragment = FragmentTerkini()
                 }
                 if (fragment != null) {
                     fragmentManager = supportFragmentManager
     ...
     private fun getCuacaToday() {
         AndroidNetworking.get(ApiEndpoint.URL_CUACA)
             ...
             .addPathParameter("API key", "6822010de82deadadbed65e4b0f0cd8d")
