...
class AdapterBerpotensi(
    private val modelGempaBerpotensi:
    List<ModelGempaBerpotensi>
) : RecyclerView.Adapter<AdapterBerpotensi.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.list_gempa_berpotensi, parent, false)
